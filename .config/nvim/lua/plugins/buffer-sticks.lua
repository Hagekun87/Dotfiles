return {
  ...
  padding = { top = 0, right = 0, bottom = 0, left = 1 }, -- Padding inside the float
  ...
  list = {
    ...
    keys = {
      close_buffer = "x",      -- Key to close buffer in list mode
      move_up = "k",           -- Key to move selection up in list mode
      move_down = "j",       -- Key to move selection down in list mode
    },
    filter = {
